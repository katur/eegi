...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LibrarySequencing.seq_tube_number'
        db.delete_column('LibrarySequencing', 'seq_tube_number')

        # Deleting field 'LibrarySequencing.seq_plate_name'
        db.delete_column('LibrarySequencing', 'seq_plate_name')

        # Adding field 'LibrarySequencing.sample_plate_name'
        db.add_column('LibrarySequencing', 'sample_plate_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'LibrarySequencing.sample_tube_number'
        db.add_column('LibrarySequencing', 'sample_tube_number',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LibrarySequencing.genewiz_tube_label'
        db.add_column('LibrarySequencing', 'genewiz_tube_label',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'LibrarySequencing.seq_tube_number'
        db.add_column('LibrarySequencing', 'seq_tube_number',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LibrarySequencing.seq_plate_name'
        db.add_column('LibrarySequencing', 'seq_plate_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Deleting field 'LibrarySequencing.sample_plate_name'
        db.delete_column('LibrarySequencing', 'sample_plate_name')

        # Deleting field 'LibrarySequencing.sample_tube_number'
        db.delete_column('LibrarySequencing', 'sample_tube_number')

        # Deleting field 'LibrarySequencing.genewiz_tube_label'
        db.delete_column('LibrarySequencing', 'genewiz_tube_label')
    ...
    models = {
        ...
        u'library.librarysequencing': {
            'Meta': {'ordering': "['sample_plate_name', 'sample_tube_number']", 'object_name': 'LibrarySequencing', 'db_table': "'LibrarySequencing'"},
