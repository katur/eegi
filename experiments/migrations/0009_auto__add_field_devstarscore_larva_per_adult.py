...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DevstarScore.larva_per_adult'
        db.add_column('DevstarScore', 'larva_per_adult',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DevstarScore.larva_per_adult'
        db.delete_column('DevstarScore', 'larva_per_adult')
