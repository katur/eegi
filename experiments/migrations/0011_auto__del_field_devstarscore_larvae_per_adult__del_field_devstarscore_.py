...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DevstarScore.larvae_per_adult'
        db.delete_column('DevstarScore', 'larvae_per_adult')

        # Deleting field 'DevstarScore.gi_score_larvae_per_adult'
        db.delete_column('DevstarScore', 'gi_score_larvae_per_adult')


    def backwards(self, orm):
        # Adding field 'DevstarScore.larvae_per_adult'
        db.add_column('DevstarScore', 'larvae_per_adult',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DevstarScore.gi_score_larvae_per_adult'
        db.add_column('DevstarScore', 'gi_score_larvae_per_adult',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'experiments.devstarscore': {
            ...
            'gi_score_larva_per_adult': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'larva_per_adult': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
