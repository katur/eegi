...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Experiment.screen_level'
        db.alter_column('Experiment', 'screen_level', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1))

        # Changing field 'ManualScore.timestamp'
        db.alter_column('ManualScore', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 9, 16, 0, 0)))

        # Changing field 'ManualScore.scorer'
        db.alter_column('ManualScore', 'scorer_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Experiment.screen_level'
        db.alter_column('Experiment', 'screen_level', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'ManualScore.timestamp'
        db.alter_column('ManualScore', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'ManualScore.scorer'
        db.alter_column('ManualScore', 'scorer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    ...
    models = {
        ...
        u'experiments.experiment': {
            ...
            'screen_level': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
        ...
        u'experiments.manualscore': {
            ...
            'scorer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
