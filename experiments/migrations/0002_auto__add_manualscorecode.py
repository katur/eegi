...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ManualScoreCode'
        db.create_table('ManualScoreCode', (
            ('id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('legacy_description', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal(u'experiments', ['ManualScoreCode'])


    def backwards(self, orm):
        # Deleting model 'ManualScoreCode'
        db.delete_table('ManualScoreCode')
