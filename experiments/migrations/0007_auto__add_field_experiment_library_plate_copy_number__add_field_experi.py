...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Experiment.library_plate_copy_number'
        db.add_column('Experiment', 'library_plate_copy_number',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.screen_level'
        db.add_column('Experiment', 'screen_level',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Experiment.library_plate_copy_number'
        db.delete_column('Experiment', 'library_plate_copy_number')

        # Deleting field 'Experiment.screen_level'
        db.delete_column('Experiment', 'screen_level')
    ...
    models = {
        ...
        u'experiments.experiment': {
            ...
            'screen_level': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
