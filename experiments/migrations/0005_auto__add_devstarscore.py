...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DevstarScore'
        db.create_table('DevstarScore', (
            ...
            ('area_adult', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('area_larva', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('area_embryo', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('count_adult', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('count_larva', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('count_embryo', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('larvae_per_adult', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
            ('embryo_per_adult', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
            ('survival', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
            ('lethality', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True)),
            ('is_bacteria_present', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True)),
            ('selected_for_scoring', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True)),
            ('gi_score_larvae_per_adult', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
            ('gi_score_survival', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal(u'experiments', ['DevstarScore'])


    def backwards(self, orm):
        # Deleting model 'DevstarScore'
        db.delete_table('DevstarScore')
    ...
    models = {
        ...
        u'experiments.devstarscore': {
            ...
            'lethality': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
