...
mutants = {
    ...
    'glp-1':
        Mutant('glp-1', 'or178', '22.5C', lambda score, scorers, dates: (
            score=='ss' or score=='sm' or score=='sw' or score=='so'
                ...
                or score=='ww' or ('20100421' not in dates
                and (score=='su' or score=='sn' or score=='mu' or score=='mn'))
        )),
    'hcp-6':
    ...
    'tba-1':
        Mutant('tba-1', 'or346', '25C', lambda score, scorers, dates: (
            score=='ss' or score=='sm' or score=='sw' or score=='so'
                or score=='mm' or score=='mw' or score=='mo'
                or (score=='ww' and 'noah' in scorers)
        )),
    'zen-4':
        Mutant('zen-4', 'or153', '22.5C', lambda score, scorers, dates: (
            score=='ss' or score=='sm' or score=='sw'
                or score=='mm' or score=='mw'
                or ((score=='so' or score=='su' or score=='sn' or score=='mo')
