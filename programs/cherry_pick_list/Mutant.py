...
mutants = {
    ...
    'emb-8':
        Mutant('emb-8', 'hc69', '25C', lambda score, scorers, dates: (
            's' in score or score=='mm' or score=='mw' or score=='mo'
                    or score=='ww'
        )),
    'glp-1':
        Mutant('glp-1', 'or178', '22.5C', lambda score, scorers, dates: (
            score=='ss' or score=='sm' or score=='sw' or score=='so'
                or score=='sn' or score=='mm' or score=='mw' or score=='mo'
                or score=='mn' or score=='ww' or ('20100421' not in dates
                and (score=='su' or score=='mu'))
        )),
    'hcp-6':
    ...
    'mbk-2':
        Mutant('mbk-2', 'dd5', '25C', lambda score, scorers, dates: (
            ...
            score=='mm' or score=='mw' or score=='mo' or score=='ww' or
            ('20100707' not in dates and (score=='su' or score=='sn' or
              score=='mu' or score=='mn'))
        )),
    'mel-26':
        Mutant('mel-26', 'or184', '22.5C', lambda score, scorers, dates: (
            's' in score or score=='mm' or score=='mw' or score=='mo'
                    or score=='ww' or score=='wo'
        )),
    'par-1':
        Mutant('par-1', 'zc310', '25C', lambda score, scorers, dates: (
            's' in score or 'm' in score or score=='ww' or score=='wo'
                or (score=='wu' and
                ('20110309' in dates or '20110330' in dates))
        )),
    'par-2':
    ...
    'rme-8':
        Mutant('rme-8', 'b1023', '20C', lambda score, scorers, dates: (
            score=='ss' or score=='sm' or score=='sw' or score=='so'
                or score=='sn' or score=='mm' or score=='mw'
                or score=='mo' or score=='ww'
        )),
    'spd-5':
    ...
    'tba-1':
        Mutant('tba-1', 'or346', '25C', lambda score, scorers, dates: (
            score=='ss' or score=='sm' or score=='sw' or score=='so'
                or score=='sn' or score=='mm' or score=='mw' or score=='mo'
                or score=='mn' or (score=='ww' and 'noah' in scorers)
        )),
    'zen-4':
        Mutant('zen-4', 'or153', '22.5C', lambda score, scorers, dates: (
            score=='ss' or score=='sm' or score=='sw' or score=='sn'
                or score=='mm' or score=='mw' or score=='mo'
                or ((score=='so' or score=='su')
                and '20100921' not in dates)
        )),
    'zyg-1':
